...
class BrandDiscoverySourceInline(admin.TabularInline):
    ...
    extra = 0
    fields = ["name", "discovery_url", "enabled"]
...
class BrandAdmin(admin.ModelAdmin):
    ...
    list_display = ["name", "region", "short_code", "domain", "status_badge",
                    "discovered", "last_checked_at", "consecutive_failures"]
    list_filter = ["status", "region", "discovered", "operator_group"]
...
class BrandDiscoverySourceAdmin(admin.ModelAdmin):
    list_display = ["name", "region", "discovery_url", "enabled"]
