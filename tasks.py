...
def discover_all_brands(trigger: str = "beat") -> BrandDiscoveryRun:
    ...
    """
    sources = list(
        BrandDiscoverySource.objects.filter(enabled=True, region__is_active=True).select_related("region")
    )
